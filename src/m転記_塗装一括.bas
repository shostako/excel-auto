...
Sub 転記_塗装一括()
    ...
    targetTables = Array("_集計期間日報塗装", "_集計期間塗装T", "_集計期間塗装G", "_集計期間日報塗装W", "_集計期間塗装H")
    ...
    macroNames = Array("転記_日報_塗装N", "転記_手直し_塗装T", "転記_流出_塗装G", "転記_日報_塗装NW", "転記_廃棄_塗装H")
