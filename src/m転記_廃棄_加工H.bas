...
' ========================================
' マクロ名: 転記_廃棄_加工H
' 処理概要: 廃棄データを期間別に9分類で集計して加工Hシートに転記
'
' 【処理の特徴】
...
'
' 【テーブル構成】
' 期間テーブル : シート「加工H」、テーブル「_廃棄項目加工H」
' ソーステーブル : シート「廃棄」、テーブル「_廃棄」；シート「ロット数量」、テーブル「_ロット数量」
' 項目テーブル : シート「加工H」、テーブル「_集計期間加工H」
' 出力テーブル : シート「加工H」、複数テーブル「_廃棄H_加工_{期間名}」
'
' 【処理フロー】
' 1. 既存出力テーブルとデータを完全削除
