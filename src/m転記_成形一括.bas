...
Sub 転記_成形一括()
    ...
    targetSheets = Array("成形N", "成形ND", "成形T", "成形G", "成形NW", "成形H")
    targetTables = Array("_集計期間日報成形", "_集計期間日報成形D", "_集計期間成形T", "_集計期間成形G", "_集計期間日報成形W", "_集計期間成形H")
    ...
    macroNames = Array("転記_日報_成形N", "転記_日報_成形ND", "転記_手直し_成形T", "転記_流出_成形G", "転記_日報_成形NW", "転記_廃棄_成形H")
